...
export const roadmap: RoadmapPhase[] = [
  ...
  },
  {
    ...
    tasks: [
      { id: "3.1", title: "Activar Lovable Cloud (DB, Auth, Storage)", status: "todo" },
      { id: "3.2", title: "Modelo: organizações, projetos, membros, papéis (RLS)", status: "todo" },
      { id: "3.3", title: "Autenticação e perfis (Super Admin, Gestor, Financiador)", status: "todo" },
      { id: "3.4", title: "Tabela user_roles + função has_role (security definer)", status: "todo" },
      { id: "3.5", title: "Isolamento por projeto via RLS (tenant = projeto)", status: "todo" },
